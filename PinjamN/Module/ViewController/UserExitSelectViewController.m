//
//  UserExitSelectViewController.m
//  PinjamN
//
...
@interface UserExitSelectViewController ()<UIPickerViewDelegate,UIPickerViewDataSource,UIGestureRecognizerDelegate>
@property (nonatomic, strong)UIPickerView   *s_pickerView;
@property (nonatomic, strong)NSDictionary   *s_dic;

@end

@implementation UserExitSelectViewController
...
- (void)viewDidLoad {
    ...
    centerImageView.image = OSLWImage(@"Detail_seletct_Image");
