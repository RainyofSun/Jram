...
#import "UserExitSelectViewController.h"

@interface UserExitViewController ()<CNContactPickerDelegate>
...
@implementation UserExitViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    [self initNaviBarWithTitle:@"Identity information" LeOSLWImage:OSLWImage(@"THblackBackImage") leftTitle:nil rightImage:nil rightTitle:nil delegate:self];
    [self snowsengland];
...
- (void)snowsengland
{
    ...
    [SVProgressHUD show];
    WEAK_SELF
    [BaseNetRequest postWithURLServiceString:snowsengland parameters:dic success:^(BaseResponseModel *model) {
        STRONG_SELF
        if (model.success) {
            [SVProgressHUD dismiss];
...
- (void)addSubViewsWithArr:(NSArray *)arr
{
    ...
    for (int k = 0; k < arr.count; k++) {
        ...
        [titBtn setImage:OSLWImage(@"Detail_contact_title_Image") forState:UIControlStateNormal];
        ...
        [titBtn.titleLabel setFont:OSLWMediumFont(18)];
        ...
        realtionShipTitLabel.font = OSLWRegularFont(16);
        ...
        NSAttributedString *accountAttrString = [[NSAttributedString alloc] initWithString:[dic stringForKey:@"followed"] attributes:@{NSForegroundColorAttributeName:UIColorFromRGB(MainText9Color),NSFontAttributeName:OSLWRegularFont(16)}];
        ...
        realtionShipTextfield.font = OSLWRegularFont(16);
        ...
        [realtionShipTextfield addTapAction:^(UIGestureRecognizer *sender) {
            ...
            UserExitSelectViewController *vc = [UserExitSelectViewController new];
        ...
        rArrowImageView.image = OSLWImage(@"Detail_contact_arrow_Image");
        ...
        phoneTitLabel.font = OSLWRegularFont(16);
        ...
        NSAttributedString *phoneAccountAttrString = [[NSAttributedString alloc] initWithString:[dic stringForKey:@"monday"] attributes:@{NSForegroundColorAttributeName:UIColorFromRGB(MainText9Color),NSFontAttributeName:OSLWRegularFont(16)}];
        phoneTextfield.attributedPlaceholder = phoneAccountAttrString;
        phoneTextfield.textColor = UIColorFromRGB(MainText3Color);
        phoneTextfield.font = OSLWRegularFont(16);
        ...
        pArrowImageView.image = OSLWImage(@"Detail_contact_arrow_Image");
...
//    }];
    ...
    [BaseNetRequest postWithURLServiceString:creditinfouploadcontactsios parameters:dic success:nil failure:nil];
...
- (void)snowsoccurring
{
    ...
    WEAK_SELF
    [BaseNetRequest postWithURLServiceString:snowsoccurring parameters:dic success:^(BaseResponseModel *model) {
        STRONG_SELF
        if (model.success) {
            [SVProgressHUD showSuccessWithStatus:model.msg];
            [CommenObject postDataWithStartTime:self.s_startTimeStr endTime:[CommenObject getTimeStampString] type:@"7" order:nil];
