...
@interface FTSelectCityVC ()<UIPickerViewDelegate,UIPickerViewDataSource,UIGestureRecognizerDelegate>
...
- (void)viewDidLoad {
    ...
    for (int k = 0; k < titArr.count; k++) {
        ...
        NSAttributedString *accountAttrString = [[NSAttributedString alloc] initWithString:@"Please choose" attributes:@{NSForegroundColorAttributeName:UIColorFromRGB(MainText9Color),NSFontAttributeName:FTRegularFont(16)}];
