...
- (void)s_addSubViewAction
{
    ...
    for (int k = 0; k < 4; k++) {
        ...
        titLabel.font = FTRegularFont(14);
        ...
        valueLabel.font = FTMediumFont(13);
...
- (UIImageView *)s_backImageView{
    if (!_s_backImageView) {
        ...
        _s_backImageView.image = FTImage(@"HomePage_cell_back_Image");
    }
...
- (UILabel *)s_priceLabel{
    if (!_s_priceLabel) {
        ...
        _s_priceLabel.font = FTBoldFont(24);
    }
...
- (UIImageView *)s_productIconImageView{
    if (!_s_productIconImageView) {
        ...
        _s_productIconImageView.image = FTImage(@"logoImage");
...
- (UILabel *)s_productTitLabel{
    if (!_s_productTitLabel) {
        ...
        _s_productTitLabel.font = FTMediumFont(14);
    }
...
- (UIButton *)s_titBtn{
    if (!_s_titBtn) {
        ...
        [_s_titBtn.titleLabel setFont:FTMediumFont(16)];
    }
    return _s_titBtn;
}
...
- (UIButton *)s_agreementBtn{
    if (!_s_agreementBtn) {
        ...
        [_s_agreementBtn.titleLabel setFont:FTBoldFont(16)];
...
- (void)setM_dic:(NSDictionary *)m_dic
{
    ...
    [self.s_productIconImageView sd_setImageWithURL:[NSURL URLWithString:[_m_dic stringForKey:@"latter"]] placeholderImage:FTImage(@"logoImage")];
