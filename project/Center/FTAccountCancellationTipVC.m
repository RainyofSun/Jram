...
@interface FTAccountCancellationTipVC ()
@property (nonatomic, strong)UIImageView         *s_centerView;

@end

@implementation FTAccountCancellationTipVC
...
- (void)addSubViews
{
    ...
    self.s_centerView.image = FTImage(@"Center_aaaaa_Image");
